    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col gap-4 mb-8">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-slate-800 mb-1">Care Recipients</h1>
            <p className="text-sm md:text-base text-slate-500">Manage profiles for your loved ones</p>
          </div>
          <Button 
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 md:py-16">
            ...
            <Button onClick={() => setShowAddForm(true)} className="bg-blue-600 hover:bg-blue-700 w-full sm:w-auto">
              <Plus className="w-4 h-4 mr-2" />
              Add Recipient
            </Button>
          </div>
